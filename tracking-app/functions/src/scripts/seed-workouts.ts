...
const SEED_WORKOUTS = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        name: 'Push-ups',
        sets: [
          { id: '1', weight: 0, reps: 20, status: StatusEnum.Pending },
          { id: '2', weight: 0, reps: 15, status: StatusEnum.Pending },
          { id: '3', weight: 0, reps: 12, status: StatusEnum.Pending },
        ],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        name: 'Pull-ups',
        sets: [
          { id: '1', weight: 0, reps: 10, status: StatusEnum.Pending },
          { id: '2', weight: 0, reps: 8, status: StatusEnum.Pending },
          { id: '3', weight: 0, reps: 6, status: StatusEnum.Pending },
        ],
      },
      {
        id: '3',
